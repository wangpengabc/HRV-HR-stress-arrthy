...
// hrvlib.jar 文件位于https://github.com/HRVBand/hrv-band/tree/master/app/libs
...
public class HRHRVStressArrhy {
     ...
     */
    public static List<HRVParameter> calcParames(String data_save_dir, String ecg_data_name) throws IOException {
        // load rr array
        String rr_data_name = ecg_data_name + "_rr";
...
//        System.out.println("value:" + rr_mean_parameter.getValue());
        ...
        // ------ test -------
        HRVParameter  lf_parameter = facade_calc.getLF();
        ...
        System.out.println("name:" + hf_parameter.getName());
        System.out.println("value:" + hf_parameter.getValue());
        System.out.println("unit:" + hf_parameter.getUnit());
